var categoryMap = {
    'Property Requirements - Unit Size': {
        keywords: ["bhk", "बीएचके", "बी एच के", "स्क्वायर"],
    ...
    'Phone Number Exchange': {
        keywords: ["नंबर", "फ़ोन नंबर", "सेल नंबर", "मोबाइल", "whatsapp"],
        description: "dummy desc1"
    },
    'Property Requirements - Sale Type': {
        keywords: ["रेंट", "रेंटल", "रिसेल", "परचेस", "बाई"],
        description: "dummy desc1"
    },
    'Ask for a Call Back': {
        keywords: ["कॉल करता"],
